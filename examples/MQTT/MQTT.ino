...
#define MQTT_PASSWORD "UNIT_PWD"
#define MQTT_D_TOPIC  "UNIT_CATM/D"
#define MQTT_U_TOPIC  "UNIT_CATM/U"  //  上传数据主题
...
void setup() {
    ...
    canvas.println(">>UNIT CatM MQTT TEST");
    canvas.pushSprite(0, 0);
    SerialAT.begin(SIM7080_BAUDRATE, SERIAL_8N1, UNIT_SIM7080_RX,
                   UNIT_SIM7080_TX);
    nbConnect();
